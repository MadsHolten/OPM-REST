...
WHERE{
    ...
    BIND(IRI(CONCAT(REPLACE(STR(?sp), "(?!([^/]*/){2}).*", "states/"), STRUUID())) AS ?stateURI)
    BIND(IRI(CONCAT(REPLACE(STR(?sp), "(?!([^/]*/){2}).*", "properties/"), STRUUID())) AS ?propURI)
}`;
    ...
    public calculationData = [
        ...
        },
        {
            ...
            argumentPaths: [
                ...
                '?sp props:airFlowrateInfiltration ?inf'],
