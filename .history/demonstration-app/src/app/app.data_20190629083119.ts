...
WHERE{
    ...
    BIND(IRI(CONCAT(REPLACE(STR(?sp), "(?!([^/]*/){3}).*", "ice/properties/"), STRUUID())) AS ?propURI)
}`;
    ...
    public calculationData = [
        {
            ...
            argumentPaths: [
                '?foi ice:surfaceExterior ?ext . ?ext a/rdfs:subClassOf+ ?restr1 . ?restr1 a owl:Restriction ; owl:onProperty props:designAmbientTemperature ; owl:hasValue ?te', 
                '?foi ice:surfaceInterior ?int . ?int a/rdfs:subClassOf+ ?restr2 . ?restr2 a owl:Restriction ; owl:onProperty props:designAmbientTemperature ; owl:hasValue ?ti'],
        ...
        },
        {
            ...
            argumentPaths: [
                '?foi ice:representsElement ?el . ?el a/rdfs:subClassOf+ ?restr . ?restr a owl:Restriction ; owl:onProperty props:thermalTransmittance ; owl:hasValue ?uVal', 
            ...
            argumentPaths: [
                '?sp props:area ?a',
                '?sp a/rdfs:subClassOf+ ?restr1 . ?restr1 a owl:Restriction ; owl:onProperty props:designAmbientTemperature ; owl:hasValue ?ti', 
                '?sp a/rdfs:subClassOf+ ?restr2 . ?restr2 a owl:Restriction ; owl:onProperty props:airFlowrateInfiltration ; owl:hasValue ?inf'],
